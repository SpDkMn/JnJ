    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form class="form-horizontal" id="form-1" name="form-1" action="{{ route('upload_cierre_post_2') }}" method="POST" enctype="multipart/form-data">
            ...
            @endforeach
            @foreach($nombreSustentos as $ns)
            <input type="hidden" name="sustento[]" value="{{ $ns }}">
            @endforeach
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-jnj" name="submit" value="{{$file}}">Confirmar Cierre</button>
            </div>
          </form>
        </div>
      </div>
