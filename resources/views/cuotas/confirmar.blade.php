    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form class="form-horizontal" id="form-1" name="form-1" action="{{ route('upload_cuota_post_2') }}" method="POST" enctype="multipart/form-data">
            ...
            @endforeach
            De la siguiente lista, los elementos correctos (<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>) serán cargados y los errores (<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>) se omitirán en la carga.
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-jnj" name="submit" value="{{$file}}">Confirmar Cuotas</button>
            </div>
          </form>
        </div>
      </div>
