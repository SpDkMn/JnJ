    ...
    <div class="row">
      <div class="col-xs-12 col-lg-12 text-center">
        <p style="background:#e5101f;opacity:0.8;padding-top:5px;padding-bottom:5px;">
          <a href="{{route('descargar_formato')}}" style="color:white;">Descarga aqui el formato del archivo de ventas <img src="{{asset('img/excel_icon.jpg')}}" alt="Archivo de excel" class="img-thumbnail img-responsive"></a>
        </p>
    ...
    <div class="row">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="{{ route('cargar_xls_avances')}}" method="POST" enctype="multipart/form-data">
