    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form class="form-horizontal" id="form-1" name="form-1" action="{{ route('mantenimiento_ejecutivo_post2') }}" method="POST" enctype="multipart/form-data">
