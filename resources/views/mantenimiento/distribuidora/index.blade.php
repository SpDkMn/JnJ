...
@section('content')
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form class="form-inline" action="{{ route('mantenimiento_distribuidora_post') }}" method="POST" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
      $('#data_representante').DataTable({"ajax": '{{route('distribuidora_list')}}'});
    });
    </script>
@stop
